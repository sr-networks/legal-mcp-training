...
def main():
    ...
    env = load_environment(
        ...
        token_penalty_weight=-0.000005,
        toolcall_penalty_weight=-0.001,
    ...
    training_args.max_tokens = 2048   # max token per turn level response
    training_args.max_seq_len = 16348  # Model's context window
